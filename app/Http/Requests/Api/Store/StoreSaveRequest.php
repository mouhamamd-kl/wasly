...
class StoreSaveRequest extends ApiRequest
{
    /**
    ...
    {
        return [
            'name' => 'required|string|max:255', // Store name
            'photo' => 'nullable|file|mimes:jpg,jpeg,png,gif', // Optional store photo
            ...
            'store_owner_id' => 'required|exists:store_owners,id', // Ensure the store owner exists
        ];
    }
