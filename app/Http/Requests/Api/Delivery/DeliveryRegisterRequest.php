...
class DeliveryRegisterRequest extends ApiRequest
{
    public function rules()
    {
        return [
            ...
            'phone' => 'required|string|unique:deliveries,phone|max:15',
            'email' => 'required|email|unique:deliveries,email|max:255',
